...
var OECDForm = function(config) {
	...
	this.save = function() {
		...
		$('#' + this.cfg.formId + ' .' + this.cfg.fieldClass).each(function(idx, field) {
			...
			if ( 
				( 'text' === type ) || ( 'select' === type ) || ( 'textarea' === type )
